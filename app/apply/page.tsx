    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-6 pb-24">
        ...
        <div className="text-center mb-10 pt-8">
          <div className="inline-block bg-brand-50 text-brand-700 text-sm font-semibold px-4 py-1.5 rounded-full mb-5">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 space-y-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-500 transition"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-500 transition resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              placeholder="e.g. Tried Habitica, a gym trainer for 3 months, YouTube productivity routines. Always works for 2-3 weeks then falls apart when I travel or have a busy week..."
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-500 transition resize-none"
            />
          </div>
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-brand-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-brand-700 transition disabled:opacity-60 shadow-lg shadow-brand-100"
            >
